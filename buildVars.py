...
addon_info = {
	...
	"addon_name": "IgnoreSelectionSpeak",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary": _("Ignore Selection Speak"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-ons manager
	"addon_description": _("""This add-on adds the current selection to the temporary dictionary, replacing it by empty string. In this way, the selection will be omitted in speech. Useful for reading texts with repeated or unnecessary words / strings. The entries added will be deleted when restart or deleting the entries in the temporary dictionary."""),
	# version
	"addon_version": "0.1",
	# Author(s)
	...
	"addon_sourceURL": "https://github.com/davidacm/IgnoreSelectionSpeak",
